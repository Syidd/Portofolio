const Contact = () => {
    return (
        <div className="kontak mt-32 sm:p-10 p-0" id="contact">
            ...
            <form action="https://formsubmit.co/hasyidfitrahasaini14@gmail.com" method="POST" className="bg-zinc-800 p-10 sm:w-fit w-full mx-auto rounded-md" autoComplete="off" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
